...
/*package*/ class Canvas_ScenePreview_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new shapesListHandler_3bcydw_a2a(myNode, getEditorContext());
  ...
  private static class shapesListHandler_3bcydw_a2a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(shapesListHandler_3bcydw_a2a.this.getNode(), LINKS.shapes$8c6y));
      try {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Shape$LQ = MetaAdapterFactory.getConcept(0x16bafbb4c6cd4cc5L, 0x83327c6de8729b3fL, 0x51dcaa29974fc161L, "Shapes.structure.Shape");
  }
